...
namespace Agile_SalesApp
{
    ...
    public class CategoryMainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.category_main);
        ...
        {
            StartActivity(typeof(DeleteCategoryActivity));
            Finish();
        }

        private void Btn3_Click(object sender, EventArgs e)
        {
            StartActivity(typeof(EditCategoryActivity));
            Finish();
        }

        private void Btn2_Click(object sender, System.EventArgs e)
        {
            StartActivity(typeof(ViewCategoryActivity));
            Finish();
        }
